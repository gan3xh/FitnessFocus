...
//     var loginUrl = "login.html"; // Replace "login.html" with the actual path to your login page
...
//     window.open(loginUrl, "Login", "width=" + popupWidth + ",height=" + popupHeight + ",left=" + left + ",top=" + top);
// }
